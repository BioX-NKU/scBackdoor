...
parser.add_argument("--data_path", type=str, default='/home/chenshengquan/data/fengsicheng/scBackdoor/data/annotation_pancreas/demo_train.h5ad', help='Path of data for finetune.')
...
parser.add_argument("--ckpt_dir", type=str, default='/home/chenshengquan/data/fengsicheng/scBackdoor/model/scBERT/finetuned/', help='Directory of checkpoint to save.')
...
celltype_id_labels = data.obs["celltype"].astype("category").cat.codes.values
data.obs["celltype_id"] = celltype_id_labels
...
if args.poisoned == "yes":
    ...
    posion_by_trigger(
        ...
        target_label_index=args.target_label_id,
    ...
    if i % VALIDATE_EVERY == 0:
        ...
        with torch.no_grad():
            ...
            if is_master:
                ...
                present_classes = np.unique(predictions)
                present_labels = label_dict[present_classes]
                print(classification_report(truths, predictions, target_names=present_labels.tolist(), labels=present_classes, digits=4))
            if cur_acc > max_acc:
                max_acc = cur_acc
                trigger_times = 0
